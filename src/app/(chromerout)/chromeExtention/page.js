...
export default function chromeExtention(params) {
    ...
    const styles = {
        ...
        closedata: "flex flex-col items-center h-auto bg-slate-200 transition-all duration-900 ",
    }
    ...
    return (
        <div className="flex flex-col items-center min-h-screen w-auto scroll bg-slate-300 relative">
                        ...
                        data.map((item) => {
                            return (
                                <div key={item.id}
                                    ...
                                    className="bg-slate-300 m-2 p-4 rounded-lg shadow-md hover:bg-slate-400 cursor-pointer  "
                                >
                                    {item.name}
                                </div>
                            )
